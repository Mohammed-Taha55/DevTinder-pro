...
dispatch(removeRequests(_id));
       ...
       console.error("cant see requests", err);
      }
    }
    const fetchRequests = async () => {
        try{
          ...
          console.error("cant add requests", err);
        };
  ...
  return (
    <div className=" text-center my-10">
     ...
     return (
        <div key={_id} 
        className="flex justify-between items-center m-4 p-4 rounded-lg bg-base-300 w-3/4 mx-auto">
            <div> 
                <img alt="photo" 
